        ...
        for name in os.listdir(src):
            ...
            if os.path.isdir(abs_path):
                ...
                if not _in_rules(rel_path, exclude):
                    ...
                    copy_dst = add_path_prefix(dst)
                    shutil.copy(abs_path, copy_dst)
    # # delete .svn when svn client less then 1.7
    # svndirs = []
    # for rt, dirs, files in os.walk(dst):
    #     for dir in dirs:
    #         if dir == ".svn":
    #             svndirs.append(os.path.join(rt, dir))
    # # print svndirs
    # for dir in svndirs:
    #     shutil.rmtree(dir)
...
if __name__ == "__main__":
    # modify by huangwei
    # custom it by yourself !!!
    # os.environ["ANDROID_SDK_ROOT"] = r"D:/adt-bundle-windows-x86_64-20140702/sdk"
    # os.environ["ANT_ROOT"] = r"D:/Source/youmi_svn/game02_src/trunk/ant/bin"
    # os.environ["NDK_ROOT"] = r"C:/ProgramData/Microsoft/AndroidNDK/android-ndk-r10e"

    print "ANDROID_SDK_ROOT", os.environ["ANDROID_SDK_ROOT"]
    print "ANT_ROOT", os.environ["ANT_ROOT"]
