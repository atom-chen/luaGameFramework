...
-- 	:done()
--
function transition.executeSequence(target)
	assert(not tolua.isnull(target), "transition.executeSequence() - target is not cc.Node")
...
-- 	:fadeIn(1)
--
function transition.executeParallel(target)
...
-- 	:done()
--
function transition.executeSpawn(target)
	assert(not tolua.isnull(target), "transition.executeParallel() - target is not cc.Node")
